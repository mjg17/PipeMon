...
dbicdump \
    ...
    -o constraint='^(job|job_status|analysis|input_id_analysis|seq_region|seq_region_attrib|attrib_type|coord_system|assembly|meta|dna_align_feature|protein_align_feature|simple_feature)$' \
